...
//                     <img src={mock} alt="Mock Tests" className="rounded-lg mb-4" />
...
//                 </div>
//                 <div className="flex flex-col items-center">
//                     <img src={studymaterials} alt="Study Materials" className="rounded-lg mb-4" />
...
//                 </div>
//                 <div className="flex flex-col items-center">
//                     <img src={guidance} alt="Expert Guidance" className="rounded-lg mb-4" />
...
//                 </div>
//                 <div className="flex flex-col items-center">
//                     <img src={sessions} alt="Interactive Sessions" className="rounded-lg mb-4" />
