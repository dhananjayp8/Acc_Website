        ...
        <div className="container mx-auto py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col items-center">
                    <img src="https://placehold.co/300x200" alt="Mock Tests" className="rounded-lg mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <img src="https://placehold.co/300x200" alt="Study Materials" className="rounded-lg mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <img src="https://placehold.co/300x200" alt="Expert Guidance" className="rounded-lg mb-4" />
                ...
                <div className="flex flex-col items-center">
                    <img src="https://placehold.co/300x200" alt="Interactive Sessions" className="rounded-lg mb-4" />
